...
#When all 7 tiles are used, word is doubled
#If a tile is on a double tile, any word intersecting that tile is doubled
#Letters are permanantly doubled or tripled